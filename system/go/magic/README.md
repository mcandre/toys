...
https://godoc.org/github.com/mcandre/toys/system/go/magic
...
```console
$ go get github.com/mcandre/toys/system/go/magic/...
```
...
$ cd "$GOPATH/src/github.com/mcandre/toys/system/go/magic"
