...
```console
$ go get github.com/mcandre/toys/system/go/applecart/...
```
...
$ sh -c "cd $GOPATH/src/github.com/mcandre/toys/system/go/applecart && go install"
```
...
$ mkdir -p "$GOPATH/src/github.com/mcandre"
$ git clone https://github.com/mcandre/toys.git "$GOPATH/src/github.com/mcandre/toys"
$ cd "$GOPATH/src/github.com/mcandre/toys/system/go/applecart"
