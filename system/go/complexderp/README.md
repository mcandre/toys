...
https://godoc.org/github.com/mcandre/toys/system/go/complexderp
...
```console
$ go get github.com/mcandre/toys/system/go/complexderp/...
```
...
$ cd "$GOPATH/src/github.com/mcandre/toys/system/go/complexderp"
